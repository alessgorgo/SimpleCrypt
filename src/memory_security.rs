...
impl From<String> for SecureString {
    fn from(s: String) -> Self {
        MemorySecurity::secure_wipe_string(&mut s.clone());
        Self { inner: s }
    }
}
...
mod tests {
    ...
    #[test]
    fn test_constant_time_compare_strings() {
        let a = "hello";
        let b = "hello";
        let c = "hellp";
        
        assert!(MemorySecurity::constant_time_compare_strings(a, b));
        assert!(!MemorySecurity::constant_time_compare_strings(a, c));
    }
}
